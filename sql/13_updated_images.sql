-- ============================================================================
-- UPDATE RECOMMENDATIONS WITH CORRECT PRODUCT IMAGES
-- ============================================================================
...
-- Create function with correct product images
    ...
    SELECT OBJECT_CONSTRUCT(
        ...
        'top_recommendations', ARRAY_CONSTRUCT(
            OBJECT_CONSTRUCT(
                ...
                'images', PARSE_JSON('["https://www.deutschjewelers.com/public/1.0/uploads/source/rolex/m126610lv-0002_01.webp", "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=300&fit=crop"]')
            ),
            OBJECT_CONSTRUCT(
                ...
                'images', PARSE_JSON('["https://images.unsplash.com/photo-1594534475808-b18fc33b045e?w=400&h=300&fit=crop", "https://images.unsplash.com/photo-1522312346375-d1a52e2b99b3?w=400&h=300&fit=crop"]')
            ),
            OBJECT_CONSTRUCT(
...
-- Test the function
SELECT '🎯 Testing updated recommendations with better images...' as test_status;
SELECT get_personal_recommendations('CUST_001', 'general') as test_result;
SELECT '✅ Updated recommendations function created!' as status; 