-- ============================================================================
-- CLEAN RECOMMENDATIONS FUNCTION (NO JSON EXTRACTION ISSUES)
-- ============================================================================
...
-- Simple test without problematic JSON extraction
SELECT '🎯 Testing clean recommendations function...' as test_status;
SELECT get_personal_recommendations('CUST_001', 'general') as test_result;
SELECT '✅ Clean recommendations function created successfully!' as status; 