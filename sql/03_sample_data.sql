...
UNION ALL
SELECT 'CITIZEN_ECO_001', 'CITIZEN', 'CASUAL', 'Eco-Drive Chandler', 'BM8180-03E', 'Solar-powered field watch with canvas strap.', 'steel', 42.00, 11.00, 100, 'solar', 'analog', 'canvas', 95.00, 95.00, 47.50, 0, 35, 10, 'SUP_005', FALSE, FALSE, TRUE, 4.2, 2341, PARSE_JSON('["https://citizen.com/eco1.jpg", "https://citizen.com/eco2.jpg"]'), PARSE_JSON('["casual", "field", "solar", "canvas"]'), PARSE_JSON('["citizen", "eco-drive", "field", "casual"]'), 'active', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()
UNION ALL
SELECT 'CASIO_GSHOCK_001', 'CASIO', 'SPORT', 'G-Shock GA-2100', 'GA-2100-1A1', 'Tough, shock-resistant watch with carbon core guard structure.', 'resin', 45.40, 11.80, 200, 'quartz', 'analog-digital', 'resin', 99.00, 99.00, 49.50, 0, 50, 15, 'SUP_006', FALSE, TRUE, TRUE, 4.6, 3247, PARSE_JSON('["https://casio.com/gshock1.jpg", "https://casio.com/gshock2.jpg"]'), PARSE_JSON('["sport", "tough", "shock", "digital"]'), PARSE_JSON('["casio", "g-shock", "tough", "shock"]'), 'active', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()
UNION ALL
